...
export default function Holyoke() {
    return (
        <div style={{ maxWidth: "120rem", overflow: "hidden", margin: "0 auto" }}>
            <Head>
                <title>Tree Stump Grinding in Vernon</title>
                <meta name="description" content="We are professionals who are ready to quickly and completely remove tree stumps in Vernon" />
                <link rel="canonical" href="https://stumpoff.com" key="canonical" />
                <meta property="og:title" content="Tree Stump Grinding" />
                <meta property="og:description" content="StumpOFF LLC is a local professional stump grinding company specializing in tree stump grinding in Connecticut, Vernon. We guarantee a careful, clean, and professional job." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://stumpoff.com/vernon" />
            ...
            <div className={style.container} id="home">
                ...
                <h1 className={style.Header}>TREE STUMP<br /> GRINDING IN Vernon</h1>
