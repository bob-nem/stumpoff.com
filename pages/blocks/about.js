        ...
        <div className={style.Wrapper}>
            <div className={style.Container} id="about">
                <div className={style.Left}>
                    <h2>ABOUT US</h2>
                    <p>StumpOFF LLC is a local professional stump grinding company specializing in tree stump grinding in Connecticut and Massachusetts. We guarantee a careful, clean, and professional job.</p>
