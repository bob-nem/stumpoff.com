        ...
        <div className={style.Container} id="feedback">
            ...
            <div className={style.ReviewList} >
                <div className={style.Review}>
                    ...
                    <a href="https://goo.gl/maps/rhwBFMunT3PCq5G99" target="_blank">Read more</a>
                </div>
                <div className={style.Review}>
                    <div className={style.ReviewHeader}>
                        <div style={{flex: "1 1 auto"}}><Image src={Gstarts} alt="fife stars review icon" /><span style={{ color: "#074578", paddingLeft: "1em" }}>5 out of 5 stars</span></div>
                    ...
                    <a href="https://goo.gl/maps/ixbLEVCS3vv9DBu78" target="_blank">Read more</a>
                </div>
                <div className={style.Review}>
                    <div className={style.ReviewHeader}>
                        <div style={{flex: "1 1 auto"}}><Image src={Gstarts} alt="fife stars review icon" /><span style={{ color: "#074578", paddingLeft: "1em" }}>5 out of 5 stars</span></div>
                    ...
                    <a href="https://goo.gl/maps/RE5TfajyPzhz63n19" target="_blank">Read more</a>
                </div>
                <div className={style.Review}>
                    <div className={style.ReviewHeader}>
                        <div style={{flex: "1 1 auto"}}><Image src={Gstarts} alt="fife stars review icon" /><span style={{ color: "#074578", paddingLeft: "1em" }}>5 out of 5 stars</span></div>
                    ...
                    <a href="https://goo.gl/maps/Ns5aviJxvNkvumxTA" target="_blank">Read more</a>
                </div>
                <div className={style.Review}>
                    <div className={style.ReviewHeader}>
                        <div style={{flex: "1 1 auto"}}><Image src={Gstarts} alt="fife stars review icon" /><span style={{ color: "#074578", paddingLeft: "1em" }}>5 out of 5 stars</span></div>
                    ...
                    <a href="https://goo.gl/maps/e4Ndo5ivYCw3QS8f8" target="_blank">Read more</a>
                </div>
                <div className={style.Review}>
                    <div className={style.ReviewHeader}>
                        <div style={{flex: "1 1 auto"}}><Image src={Gstarts} alt="fife stars review icon" /><span style={{ color: "#074578", paddingLeft: "1em" }}>5 out of 5 stars</span></div>
                    ...
                    <a href="https://goo.gl/maps/9au5aqpWn6oaE5Qh8" target="_blank">Read more</a>
                </div>
            </div>            
                <a href="https://www.google.com/search?q=stumpoff+llc&oq=stumpoff+llc&aqs=chrome..69i57j0i13.4018j0j4&sourceid=chrome&ie=UTF-8#lrd=0x89e6fb105e09b393:0x62367685dc4cedd0,1,,," target="_blank"><button className={style.Button}>All google reviews</button></a>
